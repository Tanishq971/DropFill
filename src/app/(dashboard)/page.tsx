      ...
      <main className="relative top-24 px-4 sm:px-6 lg:px-8 text-center flex-grow">
        <div className="max-w-7xl mx-auto py-20">
          <h1 className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-purple-400 bg-clip-text text-transparent mb-6">
            Welcome to Web3 Form Builder
          </h1>
          <p className="text-base md:text-lg text-gray-600 mb-8">
            Create stunning, modern forms with ease.
          </p>
          <Link href={"/signin"}>
            {" "}
            <button className="bg-purple-500 text-white px-6 py-3 rounded-full hover:bg-purple-600 transition-colors duration-300">Create</button>
          </Link>
        </div>
      </main>

     
      <section className="bg-gray-50 mx-auto w-full max-w-5xl rounded-t-3xl p-4">
        <Image
          src={preview}
          alt="preview"
